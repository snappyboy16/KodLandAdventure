...
class Hero:
    def __init__(self):
        ...
        self.animations = {
            ...
            'down_left': 'hero/player_duck_left',
        ...
        self.sound_playing = False  # Флаг для отслеживания состояния звука

    def move(self, keys, sound):
        self.is_idle = False
